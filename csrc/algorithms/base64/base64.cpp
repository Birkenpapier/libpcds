...
int main() {
    const std::string original_string = "Base64 Encoding in C++";
    std::string encoded_string = base64_encode(reinterpret_cast<const unsigned char*>(original_string.c_str()), original_string.length());
